		...
		<nav className="w-full py-14 h-20 flex items-center justify-between">
			<div className="flex items-center">
				<Link to="/" className="flex items-center gap-4">
					<h1 className="font-bold font-space text-[#F6911D] text-[55px] -translate-x-20">
						UnJorn
					</h1>
				</Link>
			</div>
			<div className="flex justify-center items-center gap-8 translate-x-4">
			...
			<div className="flex items-center justify-between gap-5 translate-x-10">
					<button className="bg-[#F6911D] w-[93px] h-[40px] rounded-3xl flex items-center justify-center">
